...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [LAYER_2] = {ENCODER_CCW_CW(KC_LBRC, KC_RBRC)},
    [LAYER_3] = {ENCODER_CCW_CW(KC_WH_D, KC_WH_U)},
    [LAYER_4] = {ENCODER_CCW_CW(KC_WH_D, KC_WH_U)},
};
#endif
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_82(
        ...
        KC_ESC,     KC_1,    KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,             KC_LNG1,
        KC_TAB,     KC_Q,    KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,             KC_LNG2,
    ...
    [LAYER_3] = LAYOUT_ansi_82(
        ...
        KC_ESC,   KC_1,     KC_2,     KC_3,     TD(TD_P50), KC_P9,    KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,               KC_TRNS,
    ...
    [LAYER_4] = LAYOUT_ansi_82(
        ...
        KC_TRNS,  KC_TRNS,  KC_TRNS,                                   KC_MUTE,                                KC_TRNS,  SGUI(KC_4),KC_TRNS, KC_MPRV,  KC_VOLD,  KC_MNXT)
};
