...
#    define SET_LED_ON(idx) led_matrix_set_value(idx, DECIDE_INDICATOR_VAL)
#    define SET_LED_BT(idx) led_matrix_set_value(idx, DECIDE_INDICATOR_VAL)
#    define SET_LED_LOW_BAT(idx) led_matrix_set_value(idx, DECIDE_INDICATOR_VAL)
