...
[LAYER_1] = LAYOUT_ansi_87(
     TG(LAYER_2),KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,             KC_LNG1,   KC_HOME,   OSL(LAYER_4),
     KC_ESC,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,    KC_BSPC, KC_LNG2,   TD(TD_P50),KC_P9,
     KC_TAB,     KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,   KC_BSLS, KC_GRV,    TD(CT_731),TD(CT_NUM),
...
[LAYER_2] = LAYOUT_ansi_87(
     TO(LAYER_3), KC_F1,    KC_F2,     KC_F3,     KC_F4,      KC_F5,      KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,             KC_S,     KC_PENT, TO(LAYER_1),
     OSL(LAYER_1),KC_F12,   TD(CT_NUM),TD(CT_731),G(KC_K),    KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_D,     KC_TAB,  KC_F,
     KC_LEAD,     G(KC_N),  KC_WH_D,   KC_ESC,    ALT_T(KC_R),TD(CT_F679),KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_C,     KC_W,    KC_Q,
     KC_TRNS,     KC_F1,    KC_SLSH,   KC_WH_U,   TD(TD_BEA), G(KC_0),    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,
     KC_TRNS,               TD(CT_GUM),TD(TD_KO), TD(TD_ZX),  TD(TD_LV),  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,            KC_TRNS,
     MO(LAYER_4), KC_TRNS,  KC_TRNS,                                      KC_SPC,                                 KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS),

[LAYER_3] = LAYOUT_ansi_87(
     TO(LAYER_1),KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,             BT_HST1,   BT_HST2,  BT_HST3,
...
[LAYER_4] = LAYOUT_ansi_87(
    ...
    KC_TILD,            G(KC_EQL),G(KC_MINS),KC_TRNS,  KC_TRNS,  BAT_LVL,  NK_TOGG,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,             KC_MPLY,            KC_VOLU,
