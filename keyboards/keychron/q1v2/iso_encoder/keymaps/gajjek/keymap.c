...
/* Alterations: First Test Flash
* Removed MAC support to save memory
* Changed rotary encoder mute click to mouse click
* Added Auto Shift
*/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT_iso_83(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   KC_DEL,             KC_MS_BTN1,
...
// Random timer within span function, pass it to the send_string_with_delay function in the intervall parameter